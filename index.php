...
if(isset($_SESSION['sessao_email'])){
    //echo "Existe sessao a passa pelo login";
}else{
   // echo"Nao existe sessao porque nao passou pelo login";
   header(header:'Location: '.$URl.' /login/ ');

}
?>
<!--<a href="../login/controlefechar.php">Fechar sessao</a>-->
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo $URL;?>public/index3.html" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="<?php echo $URL;?>public/index3.html" class="brand-link">
